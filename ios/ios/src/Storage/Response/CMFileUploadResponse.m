...
- (id)initWithResult:(int)theResult key:(NSString *)theKey {
    return [self initWithResult:theResult key:theKey snippetResult:nil responseMetadata:nil];
}

- (id)initWithResult:(int)theResult key:(NSString *)theKey snippetResult:(CMSnippetResult *)theSnippetResult {
    return [self initWithResult:theResult key:theKey snippetResult:theSnippetResult responseMetadata:nil];
}

- (id)initWithResult:(int)theResult key:(NSString *)theKey snippetResult:(CMSnippetResult *)theSnippetResult responseMetadata:(CMResponseMetadata *)theMetadata {
